...
export default function StudentBar() {
    ...
    const navItems = [
        ...
        { to: "/registration", label: t('navigation.registration') },
        { to: "/undoRegistration", label: t('navigation.undoRegistration') },
    ];
        ...
        <nav className="bg-lime-500 text-stone-100">
            <div className="container mx-auto px-4">
                <div className="flex justify-between items-center h-16">
                    <Link to="/" className="text-xl font-bold">Student</Link>
